...
When the ship drops out of hyper,  the system patrols try to stop them, and the ship has to avoid them by hiding in the asteroid field. Fred uses his pilot skill to attempt to sneak by the patrol through the asteroid field.  That is a success.  This should probably be a 
